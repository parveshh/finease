...
interface QuickExtractLogoProps extends React.SVGProps<SVGSVGElement> {
  width?: number | string;
  height?: number | string;
  className?: string;
}

const QuickExtractLogo: React.FC<QuickExtractLogoProps> = ({ width = 32, height = 32, className, ...props }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path opacity="0.4" d="M9 11H15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export default QuickExtractLogo;
